...
class HydrusCommander():
    def __init__(self, nav_mode=2, name="hydrus_commander"):
        ...
        self.errors = [False, False, False, False, False, False, False]
    ...
    def fk(self, joint_angles):
        ...
        return [end[0,0], end[1,0], joint_angles[0]+joint_angles[1]+joint_angles[2]]

    def ik(self, des_x, des_y, des_yaw, nested=False):
        #todo: use tf
        l1=0.68
        l2=0.6
        l3=0.6
        ...
        for i in range(tol+1):
            ...
            if (l2+l3)>=np.linalg.norm(l23):
                ...
                if (joints < 1.48).all() and (joints > -1.48).all():
